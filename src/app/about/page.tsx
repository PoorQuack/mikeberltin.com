                  ...
                  {stats.map((stat) => (
                    <div
                      ...
                      className="group bg-surface-card border border-panel-border rounded-2xl p-8 text-center
                                 transition-all duration-300 hover:border-gold/30 hover:-translate-y-1 hover:scale-105"
                    >
        ...
        <section className="py-24 md:py-32 bg-surface-secondary border-b border-panel-border">
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, i) => (
                <FadeInSection key={value.title} delay={i * 150}>
                  <div
                    className="group bg-surface-card border border-panel-border rounded-2xl p-8 text-center
                               transition-all duration-500 ease-out
                               hover:border-gold/30 hover:bg-surface-elevated hover:-translate-y-1 hover:scale-[1.02]
                  ...
                  >
                    ...
                    <h3 className="font-display text-xl font-bold mb-3 transition-all duration-300 group-hover:text-gold">
                      {value.title}
                    </h3>
