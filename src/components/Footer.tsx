      ...
      <div className="relative max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="text-center md:text-left">
            ...
            <p className="text-muted-dim text-sm mt-4">
          ...
          <div className="text-muted text-sm text-center md:text-right space-y-1">
            <p className="font-medium text-muted-light">info@mikeberltin.com</p>
            <p>London, United Kingdom</p>
          </div>
        </div>

        <div className="mt-16 pt-8 border-t border-panel-border text-center text-muted-dim text-xs">
