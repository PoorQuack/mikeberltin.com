      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          {trustPoints.map((point, i) => (
            <FadeInSection key={point.title} delay={i * 150}>
              <div
              ...
              >
                ...
                <h3 className="text-lg font-bold mb-3 transition-all duration-300 group-hover:text-gold">
                  {point.title}
                </h3>
              ...
              {logoPlaceholders.map((logo) => (
                <div
                  ...
                  className="w-24 h-12 bg-panel border border-panel-border rounded-lg
                             flex items-center justify-center opacity-30 hover:opacity-50 hover:scale-110
